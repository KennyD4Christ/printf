...
int print_int(char *buffer, int n, int is_negative, int width, int precision,
int zero_flag, int space_flag, int plus_flag, int minus_flag);
int print_uint(char *buffer, unsigned int n, int width,
int precision, int zero_flag);
int print_octal(char *buffer, unsigned int n, int width, int precision,
int zero_flag, int hash_flag);
